...
user in an INI file next to LibreCADPortable.exe called LibreCADPortable.ini.
...
copy AppNamePortable.ini from this directory to LibreCADPortable.ini next to
LibreCADPortable.exe. The options in the INI file are as follows:
